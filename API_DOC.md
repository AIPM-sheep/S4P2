...
本文档为“程序员成长路线”项目提供 API 使用说明。

---

## 1. 获取指定学习路线

**GET** `/api/roadmaps/{roadmap_name}`

根据提供的路线名称，返回该路线的完整学习阶段和资源。

### URL 参数

-   `roadmap_name` (string, required): 学习路线的唯一标识符。目前支持以下值：
    -   `backend-engineer`

### 成功响应 (Success Response)

-   **Code:** `200 OK`
-   **Content Example:** (以 `backend-engineer` 为例)
